 ...
 */
export declare type StepByType<A, T> = A extends {
    name: T;
} ? A : never;
/**
 ...
 */
export declare type StepMatcher<T> = {
    [K in PipelineStepName]: (step: Readonly<StepByType<PipelineStep, K>>) => T;
};
export declare type TransformStep = (step: Readonly<PipelineStep>) => void;
/**
 ...
 * class.
 */
export declare type OutputStep = {} | void;
